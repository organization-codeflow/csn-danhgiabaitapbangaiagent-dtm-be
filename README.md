...
```bash
git clone https://github.com/organization-codeflow/csn-danhgiabaitapbangaiagent-dtm-be.git
cd csn-danhgiabaitapbangaiagent-dtm-be
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-danhgiabaitapbangaiagent-dtm-be
- Xem các metrics:
